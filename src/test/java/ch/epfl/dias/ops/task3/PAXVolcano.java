...
public class PAXVolcano {
    ...
    public void init() throws IOException  {
        ...
        paxstoreOrder = new PAXStore(orderSchema, "input/orders_big.csv", "\\|", 10000);
        paxstoreOrder.load();
        
        paxstoreLineItem = new PAXStore(lineitemSchema, "input/lineitem_big.csv", "\\|", 10000);
	...
	public void query1(){
        ...
        while(!result.eof){
            outputFiled0 = result.getFieldAsInt(0);
            outputField1 = result.getFieldAsString(1);
            result = proj.next();
        }
        proj.close();
        System.out.println(outputFiled0);
        System.out.println(outputField1);
        assertTrue(outputFiled0 == 999939);
	}
